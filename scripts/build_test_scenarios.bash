...
PACKAGES=$(find src/github.com/TheLUGANSKIY/horizon/test/scenarios -iname '*.rb' -not -name '_common_accounts.rb')
# PACKAGES=$(find src/github.com/TheLUGANSKIY/horizon/test/scenarios -iname 'kahuna.rb')
...
gb generate github.com/TheLUGANSKIY/horizon/test/scenarios
# gb test github.com/TheLUGANSKIY/horizon/ingest
