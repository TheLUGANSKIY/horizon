...
import (
	...
	"github.com/TheLUGANSKIY/horizon/context/requestid"
...
func Inflate(ctx context.Context, p *P) {
	...
	p.Type = "https://TheLUGANSKIY.org/horizon-errors/" + p.Type
...
var (
	...
	ServerError = P{
		...
		Detail: "An error occurred while processing this request.  This is usually due " +
			...
			"to the issue tracker at: https://github.com/TheLUGANSKIY/horizon/issues." +
	...
	BeforeHistory = P{
		...
		Detail: "This horizon instance is configured to only track a " +
			"portion of the TheLUGANSKIY network's latest history. This request " +
	...
	StaleHistory = P{
		...
		Detail: "This horizon instance is configured to reject client requests " +
			...
			"behind the connected instance of TheLUGANSKIY-core.  If you operate this " +
