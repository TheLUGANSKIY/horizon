...
import (
	...
	"github.com/TheLUGANSKIY/horizon/resource/base"
...
var TypeNames = map[xdr.OperationType]string{
	...
	xdr.OperationTypeManageDebit:		 "manage_debit",
...
// ManageDebit represents a ManageDebit operation as it is serialized into json
// for the horizon API.
...
// DirectDebit represents a DirectDebit operation as it is serialized into json
// for the horizon API.
