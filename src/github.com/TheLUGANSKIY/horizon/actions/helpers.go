...
import (
	...
	"github.com/TheLUGANSKIY/horizon/render/problem"
	"github.com/TheLUGANSKIY/horizon/toid"
)
...
// GetAddress retrieves a TheLUGANSKIY address.  It confirms the value loaded is a
// valid TheLUGANSKIY address, setting an invalid field error if it is not.
...
// GetAccountID retireves an xdr.AccountID by attempting to decode a TheLUGANSKIY
...
// the string at the provided name in accordance with the TheLUGANSKIY client
// conventions
