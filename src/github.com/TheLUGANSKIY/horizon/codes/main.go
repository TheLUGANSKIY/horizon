...
func String(code interface{}) (string, error) {
	...
	case xdr.ManageDebitResultCode:
		switch code {
		case xdr.ManageDebitResultCodeManageDebitSuccess:
			return OpSuccess, nil
		case xdr.ManageDebitResultCodeManageDebitMalformed:
			return OpMalformed, nil
		case xdr.ManageDebitResultCodeManageDebitNoDebitor:
			return "op_no_debitor", nil
		case xdr.ManageDebitResultCodeManageDebitNoTrust:
			return "op_no_trustline", nil
		case xdr.ManageDebitResultCodeManageDebitNotFound:
			return "op_no_debit", nil
		case xdr.ManageDebitResultCodeManageDebitAlreadyExists:
			return "op_debit_already_exists", nil
		case xdr.ManageDebitResultCodeManageDebitLowReserve:
	...
	case xdr.DirectDebitResultCode:
		...
		case xdr.DirectDebitResultCodeDirectDebitMalformed:
			return OpMalformed, nil
		case xdr.DirectDebitResultCodeDirectDebitNoOwner:
			return "op_no_owner", nil
		case xdr.DirectDebitResultCodeDirectDebitNoDebit:
			return "op_no_debit", nil
		case xdr.DirectDebitResultCodeDirectDebitUnderfunded:
			return "op_underfunded", nil
		case xdr.DirectDebitResultCodeDirectDebitOwnerUnderfunded:
			return "op_owner_underfunded", nil
		case xdr.DirectDebitResultCodeDirectDebitOwnerNoTrust:
			return "op_owner_no_trustline", nil
		case xdr.DirectDebitResultCodeDirectDebitOwnerNotAuthorized:
			return "op_owner_not_authorized", nil
		case xdr.DirectDebitResultCodeDirectDebitNoDestination:
			return "op_no_destination", nil
		case xdr.DirectDebitResultCodeDirectDebitDestinationNoTrust:
			return "op_destination_no_trustline", nil
		case xdr.DirectDebitResultCodeDirectDebitDestinationNotAuthorized:
			return "op_destination_not_authorized", nil
		case xdr.DirectDebitResultCodeDirectDebitLineFull:
			return "op_line_full", nil
		case xdr.DirectDebitResultCodeDirectDebitNoIssuer:
...
func ForOperationResult(opr xdr.OperationResult) (string, error) {
	...
	case xdr.OperationTypeManageDebit:
		ic = ir.MustManageDebitResult().Code
