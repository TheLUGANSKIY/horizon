...
// both horizon's and TheLUGANSKIY-core's view of the ledger.  This package is
...
// State represents a snapshot of both horizon's and TheLUGANSKIY-core's view of the
// ledger.
type State struct {
