...
const (
	...
	// for horizon's test TheLUGANSKIY core database.
	DefaultStellarCoreURL = "postgres://localhost:5432/TheLUGANSKIY-core_test?sslmode=disable"
)
...
// StellarCore returns a connection to the TheLUGANSKIY core test database
...
// use when connecting to the TheLUGANSKIY-core database
